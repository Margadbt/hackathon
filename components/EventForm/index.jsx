  ...
  return (
    <div>
      <div className="EventFrom">
        <b>Үйл ажиллагааны бүртгэл</b>
      </div>
      <div className="request-form-card">
        <form onSubmit={handleSubmit} className="hiform">
          <div className="column">
            <label className="imgName" htmlFor="image">
              Зураг
            </label>
          ...
          <div>
            ...
            <textarea
              ...
              required
            ></textarea>
            <label htmlFor="organization1">Зохиож буй байгууллагын нэр</label>
            <textarea
              className="form-attr"
              id="organization1"
              name="organization1"
            ...
            <label htmlFor="description1">
              Үйл ажиллагааны талаар дэлгэрэнгүй тайлбар
            </label>
            <textarea
              className="form-attr"
              id="description1"
